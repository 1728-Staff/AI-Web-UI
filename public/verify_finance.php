...
file_put_contents("login_finance_debug.log", "USERNAME=[$username] | PASSWORD=[$password]\n", FILE_APPEND);

// Prepare and execute SQL query
$stmt = $mysqli->prepare("SELECT password_hash FROM finance_users WHERE username = ?");
